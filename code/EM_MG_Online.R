...
for(simu in 1:Nsimulations){
  ...
  Y=GaussianSmoothing(N=100,p=0.4,mu1=-2,mu2=2,sigma1=0.5,sigma2=0.5)
...
points(1:K, Sigma1Inf, pch = 20, col = "green", type='l', lwd = 1, cex = 0.6) 
points(1:K, Sigma1Sup, pch = 20, col = "green", type='l', lwd = 1, cex = 0.6) 
